  ...
  return (
    <div>
      ...
      <div className="sm:px-10 md:px-32 lg:px-50 xl:10px px-5 mt-10">
        <h2 className="text-3xl font-bold pb-4">Tell us your travel preferences</h2>
        ...
        <div>
          {/* Destination Input */}
          <div className="mt-20">
            <h2 className="text-xl font-medium">What is your destination choice?</h2>
            <input
              type="text"
              className="border border-slate-400 mt-2 w-full sm:w-8/12 rounded-lg h-10 px-2"
          ...
          <div className="mt-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-8/12 mt-2">
              {budgetInfo.map((item, index) => (
                <div
                  key={index}
                  className={`${
                    finalData.budget == item.name && "border-2 border-gray-950 shadow-lg"
                  } flex flex-col border border-gray-400 w-full sm:w-4/12 rounded-lg p-2 cursor-pointer`}
          ...
          <div className="mt-10">
            <h2 className="text-xl font-medium">What do you plan on traveling with on your next adventure?</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full sm:w-8/12 mt-2">
          ...
          <div className="my-10 flex justify-end w-full sm:w-8/12">
            <Button disabled={loading} onClick={inputValidate}>
